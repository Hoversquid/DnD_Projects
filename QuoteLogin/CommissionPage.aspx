            ...
            <ContentTemplate>
                    ...
                    <asp:Panel ID="ButtonMenuPanel" CssClass="RightColumnMenu" Visible="false" runat="server">
                        <asp:Table runat="server" CellPadding="5" CssClass="SelectionMenu" HorizontalAlign="Center">
                            <asp:TableRow>
                                ...
                                <asp:TableCell>
                                    <asp:Button ID="AdminBoardPanelButton" CssClass="InputCell" CausesValidation="false" runat="server" Text="Admin Board" OnClick="AdminBoardPanelButton_Click" />
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </asp:Panel>
                ...
                <div>
                            ...
                            <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                                    ...
                                    <asp:GridView Width="88%" ID="ActivitiesGridView" HorizontalAlign="Center" CellPadding="10" OnRowDataBound="ActivitiesGridView_RowDataBound" DataSourceID="ActivitiesDataSource" runat="server" AutoGenerateColumns="False" ForeColor="#333333" OnRowCreated="ActivitiesGridView_RowCreated" AllowSorting="True">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="RepairsQuota" HeaderText="Q" SortExpression="RepairsQuota" ItemStyle-Width="7.14%">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="RepairsDone" HeaderText="A" SortExpression="RepairsDone">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="AccessoriesQuota" HeaderText="Q" SortExpression="AccessoriesQuota">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="AccessoriesDone" HeaderText="A" SortExpression="AccessoriesDone">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="PreownedQuota" HeaderText="Q" SortExpression="PreownedQuota">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="PreownedDone" HeaderText="A" SortExpression="PreownedDone">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="TnDQuota" HeaderText="Q" SortExpression="TnDQuota">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="TnDDone" HeaderText="A" SortExpression="TnDDone">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="TnDCQuota" HeaderText="Q" SortExpression="TnDCQuota">
                                                
                                            </asp:BoundField>
                                            <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7.14%" DataField="TnDCDone" HeaderText="A" SortExpression="TnDCDone">
                    ...
                    <asp:Panel ID="AdminPanel" runat="server" Visible="false" Height="450px">
                        <div class="LeftColumnMenu">
                            <asp:Table Height="90px" CellPadding="0" Width="100%" runat="server">
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Label runat="server" Text="Employee: " CssClass="DropdownLabel" Font-Bold="true" Font-Size="Large" />
                                        <asp:DropDownList ID="DropDownList1" OnSelectedIndexChanged="AccessoryEmpSelectionDropdown_SelectedIndexChanged" AutoPostBack="true" CssClass="DropdownWithLabel" runat="server" AppendDataBoundItems="true" DataSourceID="EmployeeDataSource" DataValueField="EmpID" DataTextField="EmpName">
                                            <asp:ListItem Value="0" Selected="True" Text="Select Employee" />
                                        </asp:DropDownList>
                                    </asp:TableCell><asp:TableCell>
                                        <asp:Button ID="SetStoreQuotasButton" runat="server" Text="Store Quotas" OnClick="SetStoreQuotasButton_Click" />
                                    </asp:TableCell></asp:TableRow><asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Button ID="Button1" CssClass="TableFormButton" runat="server" OnClick="EmpAccessoryAddButton_Click" Text="Employee Quotas" />
                                    </asp:TableCell><asp:TableCell Width="100px" />
                                </asp:TableRow>
                                <asp:TableRow>
                                    </asp:TableRow></asp:Table></div><asp:DetailsView ID="DetailsView1" Width="40%" CssClass="RightAdminColumnMenu" Height="200px" runat="server" AutoGenerateRows="False" CellPadding="4" DataSourceID="StoreTotalsDataSource" ForeColor="#333333" GridLines="None" DataKeyNames="StoreID">
                            <CommandRowStyle BackColor="#E2DED6" Font-Bold="True" />
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <CommandRowStyle BackColor="#E2DED6" Font-Bold="True" />
                            <EditRowStyle BackColor="#999999" />
                            <FieldHeaderStyle BackColor="#E9ECF1" Width="20%" Font-Bold="True" />
                            <Fields>
                                <asp:BoundField DataField="StoreQuotaRepairs" HeaderText="Repairs" SortExpression="StoreQuotaRepairs" /><asp:BoundField DataField="StoreQuotaAccessories" HeaderText="Accessories" SortExpression="StoreQuotaAccessories" /><asp:BoundField DataField="StoreQuotaPO" HeaderText="Preowned" SortExpression="StoreQuotaPO" /><asp:BoundField DataField="StoreQuotaTnD" HeaderText="T n D" SortExpression="StoreQuotaTnD" /><asp:BoundField DataField="StoreQuotaTnDC" HeaderText="T n D Complete" SortExpression="StoreQuotaTnDC" /><asp:BoundField DataField="StoreQuotaTotal" HeaderText="Total" SortExpression="StoreQuotaTotal" /></Fields>
                            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                            <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                ...
                <asp:SqlDataSource ID="ComissionDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:QuoteDBConnection %>" SelectCommand="SELECT * FROM [AccessoriesTracker] WHERE (EmpID = @SelectedEmpID) AND (StoreID = @StoreID)"><SelectParameters><asp:ControlParameter ControlID="qcs" Name="SelectedEmpID" PropertyName="SelectedEmpID" /><asp:ControlParameter ControlID="qcs" Name="StoreID" PropertyName="StoreID" Type="Int32" /></SelectParameters></asp:SqlDataSource>
