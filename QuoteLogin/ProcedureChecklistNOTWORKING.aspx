        ...
        <div class="PrintDiv">
            ...
            <asp:Table runat="server" CssClass="PanelLabelHeader">
                <asp:TableRow>
                    ...
                    </asp:TableCell></asp:TableRow></asp:Table><asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="LeftColumnGridDiv">
                        <div style="clear: both;">
                            <div class="LeftColumnGridDiv">
                            ...
                            $$ Total
                                ...
                                Pennies:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="PennyAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="PennyAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Nickels:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="NickelAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="NickelAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Dimes:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="DimeAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="DimeAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Quarters:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="QuarterAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="QuarterAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Half Dollars:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="HalfDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="HalfDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Penny Roll:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="PennyRollAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="PennyRollAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Nickel Roll:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="NickelRollAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="NickelRollAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Dime Roll:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="DimeRollAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="DimeRollAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                Quarter Roll:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="QuarterRollAmt2Total" runat="server" CssClass="SRRequiredError" ControlToValidate="QuarterRollAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                            ...
                            $$ Total
                                ...
                                Dollar Coins:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="DollarCoinsAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="DollarCoinsAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $1 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="OneDollarAmt2Total" runat="server" CssClass="SRRequiredError" ControlToValidate="OneDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $2 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="TwoDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="TwoDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $5 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="FiveDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="FiveDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $10 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="TenDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="TenDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $20 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="TwentyDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="TwentyDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $50 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="FiftyDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="FiftyDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
                                ...
                                $100 bill:
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="CashTableValidGroup" ID="HundredDollarAmt2Valid" runat="server" CssClass="SRRequiredError" ControlToValidate="HundredDollarAmt2" Text="*" Display="Dynamic" ValidationExpression="^\d+(\.\d\d)?$" ErrorMessage="Enter valid price." />
